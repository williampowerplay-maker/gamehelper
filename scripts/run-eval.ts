...
function classifyContentType(question: string): string | null {
  ...
  const bossNames = ["kailok","hornsplitter","hernand","ludvig","gregor","fortain","gabriel","lucian","bastier","walter","lanford","master du","antumbra","crimson warden","crimson nightmare","hexe marie","demeniss","trukan","delesyia","pailune","saigord","staglord","reed devil","blinding flash","grave walker","icewalker","white horn","stoneback crab","taming dragon","tenebrum","crowcaller","draven","cassius","kearush","myurdin","excavatron","priscus","muskan","cubewalker","lithus","black fang","hemon","beindel","gwen kraber","white bearclaw","queen spider","crookrock","desert marauder","rusten","abyss kutum","kutum","goyen","matthias","white bear","t'rukan"];
